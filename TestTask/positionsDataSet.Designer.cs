...
namespace TestTask {
    ...
    public partial class stuffDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/stuffDataSet1.xsd";
...
namespace TestTask.stuffDataSetTableAdapters {
    ...
    public partial class positionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[positions] WHERE (([id] = @Original_id) AND ((@IsNull_pos_name" +
                " = 1 AND [pos_name] IS NULL) OR ([pos_name] = @Original_pos_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[positions] ([pos_name]) VALUES (@pos_name);\r\nSELECT id, pos_na" +
                "me FROM positions WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[positions] SET [pos_name] = @pos_name WHERE (([id] = @Original_id) " +
                "AND ((@IsNull_pos_name = 1 AND [pos_name] IS NULL) OR ([pos_name] = @Original_po" +
                "s_name)));\r\nSELECT id, pos_name FROM positions WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestTask.Properties.Settings.Default.stuffConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, pos_name FROM dbo.positions";
        ...
        public virtual int Fill(stuffDataSet.positionsDataTable dataTable) {
        ...
        public virtual stuffDataSet.positionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            stuffDataSet.positionsDataTable dataTable = new stuffDataSet.positionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(stuffDataSet.positionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_pos_name) {
        ...
        public virtual int Update(string pos_name, int Original_id, string Original_pos_name, int id) {
            if ((pos_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pos_name, int Original_id, string Original_pos_name) {
            return this.Update(pos_name, Original_id, Original_pos_name, Original_id);
        }
    }
